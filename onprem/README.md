...
Available views: Dashboard (monthly stats + PDF export), Shipments (read-only, live 60 s polling), Accounts (list, password reset, delete), Create Account (dedicated `/accounts/create` page).
